...
class AG_Weitere(BasisSpider):
	...
	URLS=['/de/gerichte/gesetze_entscheide/weitere_entscheide_1/weitere_entscheide_2.jsp']
	...
	def parse_page(self, response):
		...
		# Eine Listenseite
			...
			struktur=response.xpath("//div[@class='accordion__content']")
			if struktur:
				struktur_da=True
			else:
				struktur=response.xpath("//section[@class='contentcol__section']")
				struktur_da=False

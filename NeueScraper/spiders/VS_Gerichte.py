...
class VS_Gerichte(BasisSpider):
	...
	def parse_trefferliste(self, response):
		...
		logger.info("children_last_member: "+json.dumps(children_last_member))
		state_ofit=sstruk[0]['state'][struk[0]['hierarchy'][members[-1]][-2]]
		logger.info("state_ofit: "+json.dumps(state_ofit))		
